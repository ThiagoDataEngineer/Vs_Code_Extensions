...
Logo teremos que consolidar todas informacoes quanto a linhas cobertas ou nao, por fonte(Ex:FISA001 > 17 Mil linhas), entre todos os arquivos(.csv) de cada Suite de Teste. 
